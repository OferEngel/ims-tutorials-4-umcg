...
`r emo::ji("one")` [Tutorial 1 - Lesson 1: Language of data](https://oferengel.shinyapps.io/ims-01-data-01/)
...
```{r, echo=FALSE, context="server", eval = FALSE}
encoder_logic()
```

```{r encode, echo=FALSE, eval=FALSE}
