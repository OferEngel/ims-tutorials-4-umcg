...
### 1 - [Language of data](`r glue("{shiny_url}ims-01-data-01/")`)
...
### 2 - [Types of studies](`r glue("{shiny_url}ims-01-data-02/")`)
...
### 3 - [Sampling strategies and experimental design](`r glue("{shiny_url}ims-01-data-03/")`)
...
### 4 - [Case study](`r glue("{shiny_url}ims-01-data-04/")`)
