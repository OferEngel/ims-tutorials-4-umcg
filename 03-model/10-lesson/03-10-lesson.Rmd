---
title: "4.9 Case Study: Italian restaurants in NYC"
output: 
  learnr::tutorial:
    progressive: true
    allow_skip: true
...
```{r ex1-hint-1}
 The `ggpairs()` function is helpful for looking for pairs of variables that have high correlation. But before using it, you will need to remove the `Restaurant` variable
...
You have successfully completed Tutorial 4.9. 
...
To generate a hash for submission, see below.
