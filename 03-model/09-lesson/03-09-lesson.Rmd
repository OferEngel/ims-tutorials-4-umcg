...
```{r ex5, exercise=TRUE, exercise.setup="prepare-ex5"}
...
```{r ex9, exercise=TRUE, exercise.setup="ex9-setup"}
...
You have successfully completed Tutorial 4.8. To generate a hash for submission, see below.
