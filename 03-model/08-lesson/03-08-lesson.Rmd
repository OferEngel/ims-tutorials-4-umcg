...
question("This interpretation is correct …",
  answer("For each additional day the auction lasts, the expected final price declines by $1.51, after controlling for starting price.", correct = TRUE),
...
You have successfully completed Tutorial 4.7. To generate a hash for submission, see below.
