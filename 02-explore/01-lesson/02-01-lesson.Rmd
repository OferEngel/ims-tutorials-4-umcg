...
question(
  ...
  answer("Among neutral characters, the proportion of Unknown characters is the lowest", correct = TRUE, message="To compare neutral characters we need to condition on `align`")
)
...
quiz(caption = "",
  ...
  question("Using the tables above, approximately what proportion of all characters are both good and female?",    
    answer("13%", correct = TRUE, message = "Nice! To answer this question, you needed to look at the distribution of ALL the combinations. That is, you wanted the table with the joint distribution."),
    answer("34%", message = "Nope, try again!"),
    answer("44%", message = "Nope, try again!"),
    answer("51%"),
    answer("We cannot tell from the two tables", message = "Not quite!"),
  ...
  question("Using the tables above, approximately what proportion of good characters are female?",
    answer("13%"),
    answer("34%", message = "Nope, try again!"),
    answer("44%", message = "Nope, try again!"),
    answer("51%"),
    answer("We cannot tell from the two tables", correct = TRUE, message = "Nice! To answer this question, you needed to look at how `gender` was distributed *within* each `align`. That is, you wanted to *condition* on the `align` variable."),
    allow_retry = TRUE
  )
...
`r emo::ji("spiral_notepad")` [Tutorial 2: Exploratory data analysis](https://oferengel.github.io/ims-tutorials-4-umcg/02-explore/)
