...
-   Lab 2: [Intro to data](support/assignments/02_intro_to_data/) **deadline 19-Oct-23**
-   Lab 3: [Confidence intervals](https://oferengel-posit.shinyapps.io/LAB_Confidence_intervals/) **deadline 19-Oct-23**
-   Lab 4: Multiple linear least square regression part I  
-   Lab 5: Multiple linear least square regression part II  
-   Lab 6: Generalized linear models **deadline 10-Nov-23**
-   Lab 7: Probability and models with a continuous outcome 
-   Lab 8: Models with a binary outcome 
-   Lab 9: Survival analysis and review **deadline 6-Dec-23**
