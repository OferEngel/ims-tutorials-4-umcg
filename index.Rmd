---
title: "Lifecourse Epidemiology - Practicals"
...
```{r}
knitr::include_graphics("images/assignments.png")
```
...
You will find all the readings and lectures in your the [Perusall course home](https://app.perusall.com/courses/cpe-lifecourse-epidemiology).  


### Readiness assurance quizzes 

You will complete the readiness assurance quizzes **individually** before each session. During the session we will then do them again, in small groups!

-   **[RA1 Introduction](https://forms.gle/fhmW4oF8CYyx5svb9)** is due 21 November, 2024.
-   **[RA2 Descriptive statistics](https://forms.gle/wApiFj7vimpyMNkm7)** is due 26 November, 2024.
-   **RA3 Categorical outcomes** is due 4 December, 2024.
-   **RA4 Logistic Regression** is due 10 December, 2024.
...
-   **[Tutorial 1: Introduction to data](01-data/)** is due 26 November, 2024
-   **[Tutorial 2: Exploratory data analysis](02-explore/)** is due 4 December, 2024
-   **Tutorial 3: Simple linear least square regression**  is due 10 December, 2024
-   **Tutorial 4: Multiple linear least square regression**  is due 10 December, 2024
-   **Tutorial 5: Generalized linear models** is due 10 December, 2024

```{r include=FALSE, eval=FALSE}
# -   [Tutorial 3: Simple linear least square regression](https://oferengel.github.io/ims-tutorials-4-umcg/03-model/)  **is due 10 December, 2024**
# -   ~~[Week 5: Multiple linear least square regression](https://oferengel.github.io/ims-tutorials-4-umcg/03-model/index_02.html)  **is due 10 December, 2024**
# -   ~~[Week 6: Generalized linear models](https://oferengel.github.io/ims-tutorials-4-umcg/03-model/index_03.html) **is due 10 December, 2024**
...
-   **Lab 1: [Introduction to R and RStudio](https://bit.ly/UMCG-R-Labs)** is due 26 November, 2024
-  **Lab 2: [Intro to visualisation](https://bit.ly/UMCG-R-Labs)** is due 26 November, 2024
-   **Lab 3: TRAILS: descriptive statistics** is due 4 December, 2024
-    **Lab 4: TRAILS: logistic regression** is due 10 December, 2024
