...
-   Week 3: Simple linear least square regression **deadline 17-Oct-23**
-   Week 4: Multiple linear least square regression part I  **deadline 24-Oct-23**
-   Week 5: Multiple linear least square regression part II  **deadline 31-Oct-23**
-   Week 6: Generalized linear models **deadline 07-Nov-23**
-   Week 7: Probability and models with a continuous outcome **deadline MONDAY!!! 13-Nov-23**
-   Week 8: Models with a binary outcome **deadline 21-Nov-23**
-   Week 9: Survival analysis and review **deadline 28-Nov-23**

### Labs 

Only three labs are due for submission, but the rest will prepare you for them.

-   [Lab 01: Introduction to R and RStudio](support/assignments/01_intro_to_r/) - 
-   [Lab02 2: Intro to data](support/assignments/02_intro_to_data/) - 
-   Week 3: Simple linear least square regression 
-   Week 4: Multiple linear least square regression part I  **deadline 27-Oct-23**
-   Week 5: Multiple linear least square regression part II  
-   Week 6: Generalized linear models **deadline 10-Nov-23**
-   Week 7: Probability and models with a continuous outcome 
-   Week 8: Models with a binary outcome 
-   Week 9: Survival analysis and review **deadline 6-Dec-23**
