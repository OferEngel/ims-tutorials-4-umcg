...
Now go to [this link](https://istats.shinyapps.io/Association_Categorical/), and fill in the contingency table as shown below. 
...
(1) Use the `names()` function to list the variables included in the `NHANES` data frame from the [NHANES](https://CRAN.R-project.org/package=NHANES) package. (Click the link for more info.)
...
Now go to [this link](https://istats.shinyapps.io/Association_Categorical/), and fill in the contingency table according to the data shown above.  
