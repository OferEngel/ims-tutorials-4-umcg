...
### 1 - [Sampling variability](`r glue("{shiny_url}04-01-lesson/")`)
...
### 2 - [Randomization test](`r glue("{shiny_url}04-02-lesson/")`)
...
### 3 - [Errors in hypothesis testing](`r glue("{shiny_url}04-03-lesson/")`)
...
### 4 - [Parameters and confidence intervals](`r glue("{shiny_url}04-04-lesson/")`)
