...
2.  Make a side-by-side box plots of `physical_3plus` and `weight`. Is there a relationship between these two variables? What did you expect and why?

```{r, eval=FALSE, echo=FALSE}
yrbss |> drop_na(physical_3plus, weight) |> 
